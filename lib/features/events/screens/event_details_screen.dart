...
class _EventDetailsScreenState extends State<EventDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final depot = [loc['city'], loc['state']]
                          ...
                          child: Stack(
                            children: [
                              _SectionCard(
                                ...
                                children: [
                                  _kvRow('Depot', depot.isEmpty ? '—' : depot),
                                  const SizedBox(height: 8),
                                  _kvRow(
                                    'EventDescription',
                ...
                // NARROW: Column inside a scroll view -> do NOT use Expanded here.
                  Column(
                    ...
                    children: [
                      ...
                      _RightPanel(mapTilerKey: _mapTilerKey,
                        item: item,
                      ),
                    ],
                  ),
  ...
  Widget _buildMap() {
    ...
    final points = _path.map((p) => ll.LatLng(p.latitude, p.longitude)).toList();
  ...
  void _onEscalate(Map<String, dynamic> item) {
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (_) => EscalationFormScreen(
          escalationDetailsArray: item,
        ),
      ),
    );
  }
          ...
          child: ElevatedButton.icon(
            onPressed: () {
              ...
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => EscalationFormScreen(
                    escalationDetailsArray: item!,
                  ),
                ),
              );
